...
color_borde_comparador_mapas = "#252525"
color_texto_comparador_mapas = "#2AA198"

color_economia = "#1C1833"
color_texto_economia = "#CCBCFF"
color_borde_economia = "#262145"
...
div(style = "overflow-y: hidden; ",
    ...
    tags$a(
      div(class = "icono",
          style = estilar_cajas(color_economia, color_texto_economia, color_borde_economia), 
          h3("Indicadores económicos Chile"),
          tags$img(src = "www/economia_chile.png", style = "height: 150px; margin: 22px; margin-bottom: -8px; margin-top: 6px;"),
          div(style = "text-align: left !important;",
              p("Tablero que presenta ", strong("+8 indicadores económicos del Banco Central de Chile,"), "cuya presentación resumida permite analizar la situación económica del país."),
      ...
      href = "https://bastianoleah.shinyapps.io/economia_chile/", target = "_blank"),

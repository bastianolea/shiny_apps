...
fluidPage(lang = "es",
          fluidRow(
            column(12, 
                   ...
                   markdown("Este portafolio contiene pequeñas **aplicaciones web para la visualización y análisis de datos sociales**, con un interés por la facilidad de uso, la exploración y el pensamiento crítico."),
                   
                   markdown("El objetivo de estas apps **transparentar datos sociales sobre Chile de forma atractiva y sencilla**, para que cualquier persona pueda responder sus inquietudes y explorar a partir de los datos.")
...
markdown("Todas estas aplicaciones son de código abierto, y los datos son públicos. Esto significa que cualquier persona puede utilizar [el código y los datos de las aplicaciones](https://github.com/bastianolea?tab=repositories) para adentrarse en el mundo del análisis de datos y [aprender a programar en R](https://bastianolea.rbind.io/blog/r_introduccion/), el lenguaje de programación usado para desarrollar todas estas apps."),

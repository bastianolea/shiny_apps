          ...
          fluidRow(
            column(12, 
                   ...
                   div(
                     ...
                     markdown("Portafolio de aplicaciones web interactivas sobre datos sociales, diseñadas y programadas en R por [Bastián Olea Herrera](https://bastian.olea.biz), sociólogx (U. Alberto Hurtado) y magíster en sociología (U. Católica de Chile)."),
                   ),
                   
                   # intro ----
                   p("Este sitio contiene pequeñas aplicaciones web para la visualización y análisis de datos sociales, con un interés por la facilidad de uso, la exploración y el pensamiento crítico. El objetivo es", strong("transparentar datos sociales sobre Chile de forma atractiva y sencilla,"), "para que cualquier persona pueda explorar datos que le permitan responder sus inquietudes, o bien, adentrarse en el análisis de datos para  desarrollar sus propios análisis en base a los datos y código facilitados en cada app."),
                   
                   p("La idea es que otras personas puedan usar estas aplicaciones libremente, y revisar el código para aprender a programar en R, contribuyendo así a la comunidad de usuarios de R en Chile."),
                   
                   markdown("Todo el código de estas aplicaciones y otros proyectos de ciencia de datos están disponibles en [mi GitHub.](https://github.com/bastianolea?tab=repositories)")
            ),
            ...
            div(
                     ...
                     markdown("¿Quieres **aprender R** o aprender a desarrollar apps con R? [¡Contáctame!](mailto:bastianolea@gmail.com) Ofrezco clases particulares de R, asesorías, desarrollo de apps, y apoyo para cualquier tipo de proyecto.")
                   )
          )
)
```
...
div(
  fluidRow(
    column(12, 
           ...
           markdown("¡Cualquier duda o comentario es bienvenido! Puedes encontrarme [en redes sociales](www.x.com/bastimapache) o [escribirme un correo](mailto:bastianolea@gmail.com) con total libertad.")
  ...
  fluidRow(
    column(12,
                   div(
                     ...
                     markdown("Si te interesa **aprender R** o **mejorar tus habilidades con R,** [contáctame!](mailto:bastianolea@gmail.com) Ofrezco **clases particulares de R,** asesorías, y apoyo para cualquier tipo de proyecto."),
...
markdown("
  ...
  fluidRow(
    column(12, 
           ...
           markdown("[bastian.olea.biz](https://bastian.olea.biz)")
...
# cafecito ----
fluidRow(
  column(12, style = "max-width: 350px; margin: auto;",

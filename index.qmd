---
title: "Visualizadores de datos sociales"
...
fluidPage(lang = "es",
          # contador de visitas
          tags$script(HTML('<script data-goatcounter="https://bastimapache.goatcounter.com/count"
...
page_fluid(lang = "es",
          div(
                   style = css(font_size = "110%", color = color_texto, 
                               margin_left = "30px", margin_right = "30px", margin_bottom = "30px"),
...
estilo_cajas <- "display: flex; justify-content: flex-start;
             border-radius: 10px; 
                 font-size: 90%;"
...
caja_app <- function(titulo = "Delincuencia en Chile",
                     ...
                     estilo_imagen = "height: auto; max-height: 160px; width: auto; max-width: 100%; margin: auto; margin-top: 0px;",
         ...
         card(class = "cajas",
              ...
              tags$a(
                h3(titulo, class = "titulo_app"),
                href = enlace,
                style = glue("color: {colores$texto};"),
                target = "_blank")
              ),
              
              div(style = "margin: 6px; margin-left: auto; margin-right: auto;",
                  tags$a(
                    tags$img(src = imagen,
                          style = estilo_imagen),
                    href = enlace,
              ...
              div(style = "text-align: left !important; hyphens: auto;",
                     texto
                  )
         )
}
...
div(style = "display: flex; justify-content: space-between;",
   ...
   # densidad ----
   caja_app(titulo = "Densidad poblacional comunal",
             texto = div(
               markdown("Visualizador de datos que presenta la densidad de la población urbana en superficies urbanas de las comunas del país como un círculo relleno de puntos, que representan los habitantes. Entrega una forma visual de pensar la población de cada comuna, considerando su superficie.")
               ),
             enlace = "https://bastianoleah.shinyapps.io/densidad_comunas/",
             colores = colores$densidad_comunas,
             imagen = "www/densidad_comunas.png", 
             colores_claros = TRUE
    ),

   # ibg ----
   caja_app(titulo = "Índice de Brechas de Género",
             texto = div(
               markdown("El índice de brechas de género es una herramienta estadística multidimensional que permite diagnosticar el estado de las brechas de género en las diferentes comunas y regiones del país, con el objetivo de dar a conocer las inequidades de género a través de diferentes aspectos, ayudar a la elaboración de planes de acción focalizados que permitan disminuir brechas de género en sus diferentes dimensiones y variables, y monitorear el avance de los mismos y evaluar sus resultados.")
               ),
             enlace = "https://www.descentralizachile.cl/ibg/",
             colores = colores$subdere_ibg,
             imagen = "www/subdere_ibg.png", 
    ),
   
   # ebc ----
    caja_app(titulo = "Estudio de Brechas Comunales",
             texto = div(
               markdown("Esta plataforma presenta los resultados del Estudio de Brechas Comunales, realizado en 2025, cuyo objetivo fue generar y proveer información sobre la situación de infraestructura y servicios en las comunas de Chile."),
              markdown("El Estudio de Brechas Comunales fue mandatado por el artículo 45 de la Ley de Presupuesto del Sector Público 2025, y realizado por la Subdere.")
               ),
             enlace = "https://www.descentralizachile.cl/ebc/",
             colores = colores$subdere_ebc,
             imagen = "www/subdere_ebc.png", 
    ),
    
   # suicidios ----
    caja_app(titulo = "Casos de suicidio según egresos hospitalarios, por género",
             texto = div(
               markdown("Conjunto de visualizaciones que exploran los datos de egresos médicos del Ministerio de Salud de Chile, distinguiendo entre intentos de suicidio y suicidios consumados."),
              markdown("Los gráficos buscan describir las diferencias de género en el fenómeno del suicidio, mostrando desigualdades en la cantidad de intentos y en las víctimas fatales, pero también en los métodos utilizados por hombres y mujeres.")
               ),
             enlace = "https://bastianolea.github.io/minsal_suicidios_genero/",
             colores = colores$minsal_suicidios,
             imagen = "www/minsal_suicidios.png", # estilo_imagen = "height: auto; max-height: 160px; max-width: 100%; margin: auto; margin: 6px; margin-top: 0px;"
    ),
    
      # mapas censo 2024 ----
    caja_app(titulo = "Mapas del Censo 2024 a nivel de manzana",
             texto = div(
               markdown("Visualizador sencillo que permite generar mapas de comunas a nivel de manzana censal con la información nueva del Censo de Población y Vivienda 2024."),
              markdown("Esta app carga directamente a la cartografía oficial completa a nivel de manzana, sin ningún procesamiento o modificación.")
               ),
             enlace = "https://bastianoleah.shinyapps.io/censo_2024_mapas/",
             colores = colores$mapas_censo,
             imagen = "www/mapas_censo.jpg", # estilo_imagen = "height: auto; max-height: 160px; max-width: 100%; margin: auto; margin: 6px; margin-top: 0px;"
    ),
    
      # dictadura ----
    caja_app(titulo = "Violaciones a los Derechos Humanos cometidas por la dictadura cívico-militar chilena",
             texto = div(
               markdown("Infografía que recopila visualizaciones de datos acerca de los crímenes de lesa humanidad cometidos por el régimen dictatorial en Chile, entre entre 1973 y 1989."),
              markdown("El objetivo es poder compartir información de forma pedagógica y clara, para que las nuevas generaciones puedan comprender la magnitud de las violaciones a los derechos humanos cometidas.")
               ),
             enlace = "https://bastianolea.github.io/violaciones_ddhh_chile/",
             colores = colores$dictadura,
             imagen = "www/dictadura.jpg", # estilo_imagen = "height: auto; max-height: 130px; max-width: 100%; margin: auto; margin: 6px; margin-top: 0px;"
    ),
   
    
     # mideso género ----
    caja_app(titulo = "Comparación de ingresos",
             texto = div(
               markdown("Visualizador sencillo de datos de ingresos de Chile a nivel regional, comunal, y por género. Su objetivo es visibilizar diferencias de los ingresos recibidos por las y los trabajadores, permitiendo compararlos por regiones y comunas, así como también producir comparaciones de brechas de género entre hombres y mujeres."),
               ),
             enlace = "https://bastianoleah.shinyapps.io/mideso_ingresos_genero/",
             colores = colores$ingresos_genero,
             imagen = "www/ingresos_genero.png", # estilo_imagen = "height: 190px; margin: 22px; margin-bottom: 8px; margin-top: -15px;",
             colores_claros = FALSE
    ), 
    ...
    caja_app(titulo = "Delincuencia en Chile",
             texto = div(
              ...
              markdown("Selecciona una comuna y luego uno o varios delitos para obtener un gráfico de líneas que muestra una **serie de tiempo** de la cantidad de delitos, desde 2010 hasta 2026. Además, puedes visualizar la **cantidad de delitos por año** en la comuna seleccionada, el promedio de delitos en los gobiernos recientes, y una visualización de los tres **delitos más frecuentes** en cada comuna.")),
             enlace = "https://bastianoleah.shinyapps.io/delincuencia_chile/",
    ...
    #corrupción ----
   caja_app(titulo = "Corrupción en Chile",
             texto = div(
              ...
              p("Los datos son recopilados manualmente, incluyendo responsables, delitos específicos, afiliación a partidos políticos, fundaciones involucradas y más, para generar visualizaciones que permitan a la cuidadanía comprender de dónde viene la corrupción y cómo nos afecta como país.")
),
             enlace = "https://bastianoleah.shinyapps.io/corrupcion_chile/",
             colores = colores$corrupcion,
             imagen = "www/corrupcion_chile.png", # estilo_imagen = "height: 150px;  margin: 22px; margin-top: 8px;"
    ),


    #femicidios ----
    caja_app(titulo = "Femicidios en Chile",
             texto = div(
             ...
             enlace = "https://bastianoleah.shinyapps.io/femicidios_chile/",
             colores = colores$femicidios,
             imagen = "www/femicidios_chile.png", # estilo_imagen = "height: 150px; margin: 22px; margin-top: 8px;"
    ),
    
    
    
    # millonarios ----
    caja_app(titulo = "Millonarios en Chile",
             texto = div(
             ...
             enlace = "https://bastianoleah.shinyapps.io/millonarios_chile/",
             colores = colores$millonarios,
             imagen = "www/millonarios_chile.png", # estilo_imagen = "height: 150px; margin: 22px; margin-top: 8px;"
    ),

    
    # relacionador ----
    caja_app(titulo = "Relacionador de variables sociales",
             texto = div(
    ...
    # brechas de género ----
    caja_app(titulo = "Comparador de brechas de género",
             texto = div(
             ...
             enlace = "https://bastianoleah.shinyapps.io/casen_brechas_genero/",
             colores = colores$brechas,
             imagen = "www/brechas_genero_casen.png", # estilo_imagen = "height: 150px; margin: 22px; margin-top: 6px;"
    ),
    
    # comparador ----
    caja_app(titulo = "Comparador de ingresos",
             texto = div(
             ...
             enlace = "https://bastianoleah.shinyapps.io/casen_comparador_ingresos/",
             colores = colores$comparador,
             imagen = "www/comparador_casen.png", # estilo_imagen = "height: 150px; margin: 22px; margin-top: 6px;"
    ),
    
    
    # censo proyecciones ----
    caja_app(titulo = "Proyecciones de población del Censo",
             texto = div(
             ...
             enlace = "https://bastianoleah.shinyapps.io/censo_proyecciones/",
             colores = colores$censo,
             imagen = "www/censo_proyecciones.png", # estilo_imagen = "height: auto; max-height: 160px; max-width: 100%; margin: auto; margin: 6px; margin-top: 0px;"
    ),
...
div(style = "overflow-y: hidden; ",
    ...
    caja_app_chica(titulo = "Generador de ruido visual",
                   texto = "Experimento para generar ruido visual mediante texto a partir de algunos parámetros personalizables. La idea es que las olas de texto produzcan efectos visuales interesantes.",
                   color = "#262626",
                   enlace = "https://bastianoleah.shinyapps.io/ruido_visual/"
    )
)
```
...
div(style = "margin-left: -28px; padding-top: 24px; text-align: center; margin: auto; transform:scale(.7); opacity: 90%;",

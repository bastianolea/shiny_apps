...
div(style = "overflow-y: hidden; ",
   ...
   # suicidios ----
    caja_app(titulo = "Casos de suicidio según egresos hospitalarios, por género",
             ...
             imagen = "www/minsal_suicidios.png", estilo_imagen = "height: 160px; margin: 6px; margin-top: 0px;"
    ),
    ...
    caja_app(titulo = "Mapas del Censo 2024 a nivel de manzana",
             ...
             imagen = "www/mapas_censo.png", estilo_imagen = "height: 160px; margin: 6px; margin-top: 0px;"
    ),
    ...
    caja_app(titulo = "Violaciones a los Derechos Humanos cometidas por la dictadura cívico-militar chilena",
             texto = div(
              ...
              markdown("El objetivo es poder compartir información de forma pedagógica y clara, para que las nuevas generaciones puedan comprender la magnitud de las violaciones a los derechos humanos cometidas en ese período, y así contribuir a la memoria histórica del país.")
               ),
             enlace = "https://bastianolea.github.io/violaciones_ddhh_chile/",
             colores = colores$dictadura,
             imagen = "www/dictadura.jpg", estilo_imagen = "height: 130px; margin: 12px; margin-top: 8px;"
    ),

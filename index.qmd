...
estilo_cajas <- "margin: 18px; padding: 16px; padding-top: 1px; 
...
div(style = "overflow-y: hidden; ",
     ...
     #delincuencia ----
  tags$a(
    div(style = estilar_cajas(color_delincuencia, color_texto_delincuencia), 
        h3("Delincuencia en Chile"),
        tags$img(src = "www/delincuencia_chile.png", style = "height: 150px;  margin: 22px;"),
        p("Visualización de estadísticas oficiales de delincuencia, separadas por comuna y delito, que busca darle contexto y seriedad a un tema país"),
    ),
